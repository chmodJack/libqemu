                                        ...
                                        MemTxAttrs attrs)
{
    ...
    if (!memory_region_access_valid(mr, addr, size, false, attrs))
	{
		...
		if(0 == libqemu_memory_read(mr, addr, pval, size, attrs))
		{
    ...
    MemTxResult r = memory_region_dispatch_read1(mr, addr, pval, size, attrs);
    adjust_endianness(mr, pval, op);
    return r;
}
                                         ...
                                         MemTxAttrs attrs)
{
    ...
    if (!memory_region_access_valid(mr, addr, size, true, attrs))
	{
		...
		if(0 == libqemu_memory_write(mr, addr, &data, size, attrs))
			return MEMTX_OK;
		//LIBQEMU_END
