...
Member C<encryption_key_missing> is deprecated.  It is
always false.
...
Member C<status> is deprecated.  Use C<recording> and
C<locked> instead.
...
Member C<dirty-bitmaps> is deprecated.  Use C<inserted>
member C<dirty-bitmaps> instead.
...
=item C<allow-write-only-overlay>
...
Members C<base> and C<top> are deprecated.  Use C<base-node>
and C<top-node> instead.
...
Member C<device> is deprecated.  Use C<id> instead.
...
B<If:> C<defined(CONFIG_LINUX_IO_URING)>
...
=item C<namespace: string> (optional)
...
=item The members of C<BlockdevOptionsGenericFormat> when C<driver> is "compress"
...
B<Arguments:> the members of C<BlockExportNbd>
...
=item C<type: BlockExportType>

Not documented

=item The members of C<BlockExportNbd> when C<type> is "nbd"
...
B<Arguments:> the members of C<Netdev>
...
=item C<show-cursor: boolean> (optional)
...
amount of setup time in milliseconds B<before> the
iterations begin but B<after> the QMP command is issued. This is designed
...
=item C<throttle-trigger-threshold>
...
=item C<multifd-compression>

Which compression method to use.
Defaults to none. (Since 5.0)

=item C<multifd-zlib-level>
...
=item C<throttle-trigger-threshold: int> (optional)
...
=item C<multifd-compression: MultiFDCompression> (optional)

Which compression method to use.
Defaults to none. (Since 5.0)

=item C<multifd-zlib-level: int> (optional)
...
=item C<multifd-zstd-level: int> (optional)
...
=item C<mode: MonitorMode> (optional)

Selects the monitor mode (default: readline in the system
emulator, control in qemu-storage-daemon)

=item C<pretty: boolean> (optional)
...
=item C<default-value: value> (optional)
...
error to specify the same option both on the top level and in C<props>.
...
Member C<arch> is deprecated.  Use C<target> instead.
...
=item The members of C<NumaHmatLBOptions> when C<type> is "hmat-lb"


=item The members of C<NumaHmatCacheOptions> when C<type> is "hmat-cache"
...
B<HmatLBMemoryHierarchy> (Enum)


The memory hierarchy in the System Locality Latency and Bandwidth
Information Structure of HMAT (Heterogeneous Memory Attribute Table)

For more information about C<HmatLBMemoryHierarchy>, see chapter
...
B<HmatLBDataType> (Enum)


Data type in the System Locality Latency and Bandwidth
Information Structure of HMAT (Heterogeneous Memory Attribute Table)

For more information about C<HmatLBDataType>, see chapter
...
B<NumaHmatLBOptions> (Object)


Set the system locality latency and bandwidth information
between Initiator and Target proximity Domains.

For more information about C<NumaHmatLBOptions>, see chapter
...
=item C<hierarchy: HmatLBMemoryHierarchy>

the Memory Hierarchy. Indicates the performance
of memory or side cache.

=item C<data-type: HmatLBDataType>
...
the value of latency from C<initiator> to C<target>
proximity domain, the latency unit is "ns(nanosecond)".

=item C<bandwidth: int> (optional)

the value of bandwidth between C<initiator> and C<target>
...
B<HmatCacheAssociativity> (Enum)


Cache associativity in the Memory Side Cache Information Structure
of HMAT

For more information of C<HmatCacheAssociativity>, see chapter
...
B<HmatCacheWritePolicy> (Enum)


Cache write policy in the Memory Side Cache Information Structure
of HMAT

For more information of C<HmatCacheWritePolicy>, see chapter
...
B<NumaHmatCacheOptions> (Object)


Set the memory side cache information for a given memory domain.

For more information of C<NumaHmatCacheOptions>, see chapter
5.2.27.5: Table 5-147: Field "Cache Attributes" of ACPI 6.3 spec.
...
=item C<associativity: HmatCacheAssociativity>

the cache associativity,
none/direct-mapped/complex(complex cache indexing).

=item C<policy: HmatCacheWritePolicy>
